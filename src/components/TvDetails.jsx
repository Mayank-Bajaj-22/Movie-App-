...
const TvDetails = () => {
  ...
  return info ? (
    ...
    >
      ...
      <div className="w-full flex overflow-x-auto gap-6 pb-5 scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-zinc-900">
        {info.detail.seasons.length > 0 ? (
          info.detail.seasons.map((s, i) => (
            <div
              key={i}
              className="min-w-[200px] bg-zinc-900 rounded-lg overflow-hidden shadow-lg hover:scale-105 transition-transform duration-300"
            >
              <img
              ...
              <div className="p-3">
                ...
                <p className="text-sm text-zinc-400">
                  {s.air_date ? s.air_date.split("-")[0] : "N/A"} •{" "}
