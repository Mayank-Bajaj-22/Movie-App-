...
const Header = ({ data }) => {
  ...
  return (
    <div
      ...
      className="w-full h-[50vh] flex flex-col justify-end items-start px-[5%] py-[3%]"
    >
      ...
      <Link to={`/${data.media_type}/details/${data.id}/trailer`} className="bg-[#6556CD] p-3 rounded mt-3 text-white">
        Watch Trailer
      </Link>
    </div>
  );
