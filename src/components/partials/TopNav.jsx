...
const TopNav = () => {
  ...
  return (
    <div className="w-[70%] h-[10vh] relative flex justify-start ml-[18%] items-center">
      ...
      <div className="absolute top-[100%] left-[5%] w-[58%] max-h-[50vh] bg-zinc-200 overflow-y-auto rounded z-999">
        {searches.map((s, i) => (
          <Link
